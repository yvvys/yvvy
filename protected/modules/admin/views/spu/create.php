								...
								<!-- BEGIN FORM-->
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<?php echo $form->dropDownList($model,'classfy_id',$data,array('class'=>'span6'));?>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="radio" name="Spu[is_sale]" value="1" />
											...
											<input type="radio" name="Spu[is_sale]" value="0" checked />
